...
# 站点信息
SITE = {
    'team': 'blog.xuyukun.com',
    'dns': ALLOWED_HOSTS[0],
    'host': 'https://{}'.format(ALLOWED_HOSTS[0]),
    'name': '坤子的博客',
    'me': 'https://blog.xuyukun.com',
    'author': "ring0",
    'email': {
        'jubao': 'xuyukun@outlook.com',
        'tougao': 'xuyukun@outlook.com',
        'support': 'xuyukun@outlook.com',
        'me': 'xuyukun@oulook.com',
    },
    # 工信部备案号
    'icp': {
        'code': '京ICP备14032074号-1',
...
# celery配置
CELERY_BROKER_URL = BROKER_URL = 'redis://127.0.0.1:6379/8'
...
# ----------本站系统所用email配置----------
SERVER_EMAIL = 'niubide@xuyukun.com'
...
EMAIL_HOST_USER = 'niubide@xuyukun.com'
EMAIL_HOST_PASSWORD = 'fdgvjzlhtwrkbiab'
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
...
DEFAULT_FROM_EMAIL = 'niubide@xuyukun.com'
EMAIL_SUBJECT_PREFIX = '[坤子的博客]'
